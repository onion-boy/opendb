...
-- Started on 2022-12-27 21:27:52
...
--
-- TOC entry 3327 (class 1262 OID 32833)
...
--
-- TOC entry 219 (class 1255 OID 32865)
-- Name: assign_unique_id(); Type: FUNCTION; Schema: users; Owner: openDB
--

CREATE FUNCTION users.assign_unique_id() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION users.assign_unique_id() OWNER TO "openDB";
...
--
-- TOC entry 3179 (class 2606 OID 32874)
...
--
-- TOC entry 3181 (class 2606 OID 32876)
...
--
-- TOC entry 3182 (class 2620 OID 32866)
-- Name: basic beforeuserupdate; Type: TRIGGER; Schema: users; Owner: openDB
--

CREATE TRIGGER beforeuserupdate BEFORE INSERT ON users.basic FOR EACH ROW EXECUTE FUNCTION users.assign_unique_id();
...
-- Completed on 2022-12-27 21:27:53
